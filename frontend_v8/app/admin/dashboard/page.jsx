...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (parsedAuth.user.role.toUpperCase() !== "ADMIN") {
      router.push("/admin/login");
      return;
    }
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-8">
              <Link href="/admin/dashboard" className="text-red-600 transition-colors font-semibold cursor-pointer">Dashboard</Link>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-red-100">
                  Monitor and manage your CareerPath AI platform
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-gray-900">
                    {stats.resumesParsed.toLocaleString()}
                  </div>
                ...
                stats.recentActivities.map((activity, index) => (
                  ...
                  >
                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm">
                      <i
                        className={`${activity.icon} ${activity.color} text-lg`}
                      ></i>
                    </div>
