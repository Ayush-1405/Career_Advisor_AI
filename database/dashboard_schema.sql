...
INSERT INTO user_profile_completion (user_id, has_resume, has_skills_assessment, completion_percentage) 
SELECT id, FALSE, FALSE, 0 FROM users WHERE role = 'USER' LIMIT 5;
